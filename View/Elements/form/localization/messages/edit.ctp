...
if ($modified) {
	echo $this->Html->div('message-modified', 'Created: ' . $this->Time->timeAgoInWords($created));
	echo $this->Html->div('message-modified', 'Last modified: ' . $this->Time->timeAgoInWords($modified));
}
